...
services:
  ...
  authentik-server:
    ...
    environment:
      ...
      AUTHENTIK_POSTGRESQL_HOST: database
      AUTHENTIK_POSTGRESQL_USER: ${AUTHENTIK_POSTGRES_USER}
      AUTHENTIK_POSTGRESQL_PASSWORD: ${AUTHENTIK_POSTGRES_PASSWORD}
      AUTHENTIK_POSTGRESQL_NAME: ${AUTHENTIK_POSTGRES_DB}
      AUTHENTIK_REDIS_HOST: redis
      AUTHENTIK_BOOTSTRAP_PASSWORD: ${AUTHENTIK_BOOTSTRAP_PASSWORD:-admin}
      AUTHENTIK_BOOTSTRAP_EMAIL: "admin@example.com"
      AUTHENTIK_HOST: "http://192.168.178.7:9000"
      AUTHENTIK_HOST_HTTPS: "https://192.168.178.7:9443"
    volumes:
